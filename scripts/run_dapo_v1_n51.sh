...
OUT_DIR=${PL_DAPO_DIR:-"runs/qwen_dapo_v1_n51"}
...
python3 -m verl.trainer.main_ppo \
  ...
  data.train_files=data/verl_train_v0_5.parquet \
  data.val_files=data/verl_val_v0_5.parquet \
  ...
  trainer.experiment_name=qwen3-8b-dapo-v1-n51 \
  trainer.nnodes=1 \
