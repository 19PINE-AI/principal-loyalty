#!/usr/bin/env python3
"""Held-out per-vendor failure decomposition (mirror of xvendor_failure_decomp.py)."""
...
VENDORS = [
    ("deepseek_heldout", "DeepSeek-v3.1"),
