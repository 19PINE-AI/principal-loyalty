...
\caption{The selective/over-refusing split persists on held-out items. (a) Five-seed means ($\pm1\sigma$) on the 36-item core reveal a 34-point gap. (b) Held-out rates use each subject's valid cells; labels give harmful/valid cells. Mistral-Large was unmeasurable, and Gemini-2.5-flash was not rerun.}
\label{fig:xsubj}
\end{figure*}
